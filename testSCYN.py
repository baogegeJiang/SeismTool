...
argL=[['SCYNdoV40', 'SCYNdoV40V028', '0', UTCDateTime(2014,1,1).timestamp, UTCDateTime(2015,7,1).timestamp],\
      ['SCYNdoV40', 'SCYNdoV40V029', '0', UTCDateTime(2015,7,1).timestamp, UTCDateTime(2017,1,1).timestamp],\
      ['SCYNdoV40', 'SCYNdoV40V030', '1', UTCDateTime(2017,1,1).timestamp, UTCDateTime(2018,7,1).timestamp],\
      ['SCYNdoV40', 'SCYNdoV40V031', '1', UTCDateTime(2018,7,1).timestamp, UTCDateTime(2020,1,1).timestamp],]
