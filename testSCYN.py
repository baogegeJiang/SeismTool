...
def do(l):
    from SeismTool.deepLearning import fcn 
    #l=['SCYN_all1120','SCYN_all1120V1','0',UTCDateTime(2014,1,1).timestamp,UTCDateTime(2015,7,1).timestamp]
...
'''
argL=[['SCYN1120','SCYN1120V1','0',UTCDateTime(2014,1,1).timestamp,UTCDateTime(2015,7,1).timestamp],\
      ['SCYN1120','SCYN1120V2','0',UTCDateTime(2015,7,1).timestamp,UTCDateTime(2017,1,1).timestamp],\
      ['SCYN1120','SCYN1120V3','1',UTCDateTime(2017,1,1).timestamp,UTCDateTime(2018,7,1).timestamp],\
      ['SCYN1120','SCYN1120V4','1',UTCDateTime(2018,7,1).timestamp,UTCDateTime(2020,1,1).timestamp],]
with Pool(4) as p:
    p.map(do,argL[:])
